  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
        <img src="img/rban3.jpg" style="width:100%;">
        
      </div>
    
      <div class="item">
        <img src="img/rban4.jpg" alt="New York" style="width:100%;">
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="#">Inspiron 50</a></h3>
										<h4 class="product-price">25080.00 </h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Sony headset</a></h3>
										<h4 class="product-price">2380.00 </h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Lenovo 2NIN</a></h3>
										<h4 class="product-price">30000.00 </h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Lenovo M10</a></h3>
										<h4 class="product-price">15000.00 </h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Thoshiba headset</a></h3>
										<h4 class="product-price">1675.00 </h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Dell Inspiron 3565</a></h3>
										<h4 class="product-price">30000.00</h4>
									</div>
								</div>
								<!-- product widget -->
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Samsung S8</a></h3>
										<h4 class="product-price">15400.00</h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">HP 15s</a></h3>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Fujifilm mini cam</a></h3>
										<h4 class="product-price">1980.00</h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
