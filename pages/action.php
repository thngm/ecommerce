							...
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>This product has a return policy.This product should be returned within 10 days of product delivery ,if undesired.</p>
										</div>
									</div>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@th.com">
